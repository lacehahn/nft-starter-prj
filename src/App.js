...
const App = () => {
  ...
  */
    ...
    try {
      ...
      */
      ...
      if (chainId == goerliChainId) {
        alert("You are connected to the Goerli Test Network!");
      } else {
  ...
  const askContractToMintNft = async () => {
    //It should be store in the ENV in the real env
    const CONTRACT_ADDRESS = "0xcef0fe54ef8b6056750d8711cbfdcf92c35dc159";
